                ...
                <div className="multiFormContainer py-5">
                    ...
                    <form id="multiStepForm" onSubmit={handleSubmit}>
                        ...
                        <div className={`form-section ${currentStep === 1 ? 'active' : ''}`}>
                            ...
                            <div className="row align-items-start mb-3"><div className="col-lg-3 d-lg-block d-none"><label htmlFor="industry" className="form-label">Industry</label></div><div className="col-lg-9 col-12"><select id="industry" className="form-select bg-transparent" value={formData.industry} onChange={handleChange}><option value="">Select industry</option><option value="IT">IT</option><option value="Design">Design</option></select></div></div>
                            <div className="row align-items-start mb-3"><div className="col-lg-3 d-lg-block d-none"><label htmlFor="jobType" className="form-label">Job Type</label></div><div className="col-lg-9 col-12"><select id="jobType" className="form-select bg-transparent" value={formData.jobType} onChange={handleChange}><option value="">Select type</option><option value="Full Time">Full Time</option><option value="Part Time">Part Time</option></select></div></div>
                            <div className="row align-items-start mb-3"><div className="col-lg-3 d-lg-block d-none"><label htmlFor="workplace" className="form-label">Workplace</label></div><div className="col-lg-9 col-12"><select id="workplace" className="form-select bg-transparent" value={formData.workplace} onChange={handleChange}><option value="">Select Workplace</option><option value="Home">Home</option><option value="Office">Office</option></select></div></div>
                        ...
                        <div className={`form-section ${currentStep === 2 ? 'active' : ''}`}>
                            ...
                            <div className="row align-items-start mb-3"><div className="col-lg-3 d-lg-block d-none"><label htmlFor="experience" className="form-label">Job Experience</label></div><div className="col-lg-9 col-12"><select id="experience" className="form-select bg-transparent" value={formData.experience} onChange={handleChange}><option>No experience required</option><option>1-2 Years</option><option>3-5 Years</option></select></div></div>
