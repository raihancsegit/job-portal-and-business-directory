// src/pages/dashboard/UpdateOpportunityPage.jsx
...
const UpdateOpportunityPage = () => {
    ...
    useEffect(() => {
        const fetchOpportunity = async () => {
            ...
            try {
                ...
                setFormData({
                    jobTitle: apiData.job_title, industry: apiData.industry, jobType: apiData.job_type,
                    workplace: apiData.workplace, location: apiData.location, salaryCurrency: apiData.salary_currency,
                    salaryAmount: apiData.salary_amount, salaryType: apiData.salary_type, jobDetails: apiData.job_details,
                    responsibilities: apiData.responsibilities, qualifications: apiData.qualifications, skills: apiData.skills,
                    experience: apiData.experience, educationLevel: apiData.education_level, vacancyStatus: apiData.vacancy_status,
                    publishDate: formatDateForInput(apiData.publish_date), endDate: formatDateForInput(apiData.end_date),
                });
            } catch (error) {
    ...
    if (loading || !formData) {
        return <div className="p-4 text-center">Loading opportunity data...</div>;
    }
        ...
        <div className="i-card-md radius-30">
            <div className="card-body">
                <div className="d-flex align-items-center gap-2 mb-5"> 
                    <button className="icon-btn-lg" type="button" onClick={() => navigate(-1)}><i className="ri-arrow-left-s-line"></i></button>
                    <div className="update-tile"><h3><span>Update</span> {formData.jobTitle}</h3></div>
                </div>
                <div className="multiFormContainer py-5">
                    ...
                    <form id="updateOpportunityForm" onSubmit={handleSubmit}>
                        ...
                        <div className={`form-section ${currentStep === 1 ? 'active' : ''}`}>
                            ...
                            <div className="row align-items-start mb-3"><div className="col-lg-3 d-lg-block d-none"><label htmlFor="jobTitle">Job Title</label></div><div className="col-lg-9 col-12"><input type="text" id="jobTitle" className="form-control" value={formData.jobTitle || ''} onChange={handleChange} required /></div></div>
                            ...
                            <div className="row align-items-start mb-3"><div className="col-lg-3 d-lg-block d-none"><label htmlFor="location">Location</label></div><div className="col-lg-9 col-12"><input type="text" id="location" className="form-control" value={formData.location || ''} onChange={handleChange} required /></div></div>
                            <div className="row align-items-start mb-3"><div className="col-lg-3 d-lg-block d-none"><label>Salary</label></div><div className="col-lg-9 col-12"><div className="d-flex flex-row gap-0"><div className="small-select"><select id="salaryCurrency" className="form-select rounded-end-0" value={formData.salaryCurrency || 'USD'} onChange={handleChange}><option>USD</option></select></div><div className="w-100 grow-1"><input type="text" id="salaryAmount" className="form-control rounded-0" value={formData.salaryAmount || ''} onChange={handleChange} /></div><div className="small-select"><select id="salaryType" className="form-select rounded-start-0" value={formData.salaryType || 'Hourly'} onChange={handleChange}><option>Hourly</option></select></div></div></div></div>
                        ...
                        {/* ================== Step 3: Publish Opportunity (সম্পূর্ণ কোড) ================== */}
