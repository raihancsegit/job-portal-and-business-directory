...
const Column = ({ id, title, className, applicants }) => { const { setNodeRef } = useDroppable({ id }); return ( <div className="i-card-md bordered-card h-100 d-flex flex-column"> <div className="applicant-header"> <div className="d-flex align-items-center gap-2"> <span className={`status-dot ${className}`}></span> <h5 className="title">{title} ({applicants.length})</h5> </div> <button className={`status-indicator ${className}`}>
                                                       <span></span>
                                                       <span></span>
                                                       <span></span>
