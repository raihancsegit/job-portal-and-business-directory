(function () {
    // Basic Line Chart
    var apexLine = document.getElementById('apexline-1');
    if (apexLine) {
        ...
        var chart = new ApexCharts(apexLine, options);
        chart.render();
    }

    var apexLineTwo = document.getElementById('apexline-2');
    if (apexLineTwo) {
        var options = {
            series: [{
                name: 'XYZ MOTORS',
        ...
        var chart = new ApexCharts(apexLineTwo, options);
        chart.render();
    }

    // Area chart
    var apexAreaOne = document.getElementById('apexarea-1');
    if (apexAreaOne) {
        (options = {
            series: [
        ...
        var chart = new ApexCharts(apexAreaOne, options);
        chart.render();
    }

    var apexAreaTwo = document.getElementById('apexarea-2');
    if (apexAreaTwo) {
        (timelinechart = {
            series: [
                {
        ...
        var chart = new ApexCharts(apexAreaTwo, timelinechart);
        chart.render();
    }


    // Column Chart 
    var apexColumn = document.getElementById('apexColumn');
    if (apexColumn) {
        var options = {
            series: [{
                name: 'Net Profit',
        ...
        var chart = new ApexCharts(apexColumn, options);
        chart.render();
    }

    var apexColumnTwo = document.getElementById('apexColumn_2');
    if (apexColumnTwo) {
        var options = {
            series: [{
                name: 'Cash Flow',
        ...
        var chart = new ApexCharts(apexColumnTwo, options);
        chart.render();
    }

    // MIXED CHARTS
    const mixedChartOne = document.getElementById("mixedChartOne")
    if (mixedChartOne) {
        var options = {
            series: [{
                name: 'Website Blog',
        ...
        var chart = new ApexCharts(mixedChartOne, options);
        chart.render();

    }

    const mixedChartTwo = document.getElementById("mixedChartTwo")
    if (mixedChartTwo) {
        var options = {
            series: [{
                name: 'TEAM A',
        ...
        var chart = new ApexCharts(mixedChartTwo, options);
        chart.render();
    }
    ...
    if (pieChartOne) {
        ...
        var chart = new ApexCharts(pieChartOne, options);
        chart.render();
    }
    ...
    if (pieChartTwo) {
        ...
        var chart = new ApexCharts(pieChartTwo, options);
        chart.render();
    }
